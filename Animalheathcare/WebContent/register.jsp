...
<div id="header">
    ...
    <div id="menu_wrapper">
        <div id="menu">
            <ul id="menu-main-menu" class="menu"><li id="menu-item-10" class="sm2 menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-54">
            <a href="home.jsp">Home</a></li>
            <li class="sm1 menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-55"><a href="#newclents">New Clients</a>
<ul class="sub-menu">
	<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-79"><a href="login.jsp">Login</a></li>
</ul>
</li>
...
</li><li id="menu-item-55" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-2 current_page_item menu-item-10">
...
<div id="main">	<div id="content">
			...
			<div class="col_lft">
			<label>Name :</label><span class="wpcf7-form-control-wrap owners_name"><br></br>
			<input type="text" name="Name" value="Name" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" required/></span><br /><br></br>
			<label>Email id  :</label><span class="wpcf7-form-control-wrap owners_name"><br></br>
			<input type="text" name="email" value="email" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" pattern="[^ @]*@[^ @]*"/></span><br /><br></br>
			
			<label>number :</label><span class="wpcf7-form-control-wrap owners_name"><br></br>
			<input type="text" name="number" value="123456789" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" pattern="[789][0-9]{9}" /></span><br /><br></br>
			
			<label>Password :</label><span class="wpcf7-form-control-wrap you_email"><br></br>
			<input type="password" name="Pass" value="Pass" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" required/></span><br></br>
			
			<input type= "submit" value="submit" class="wpcf7-form-control wpcf7-submit"/>
			<input type ="button" value="reset" class="wpcf7-form-control wpcf7-submit"/><br></br>
			<a href="login.jsp" class="aa">Already have a account  </a>
