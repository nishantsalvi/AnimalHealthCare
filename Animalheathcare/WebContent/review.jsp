...
<div id="main">	<div id="content">
		...
		<textarea  rows="8" cols="100" placeholder="Leave a Review" name="comment" required></textarea><br></br>
           <input type="submit" value="Submit"/>
          
           </form> 
		 </div><br></br>
           <div style=" position: -webkit-sticky; /* Safari */
  position: sticky; top: 0; width: 935px;height:500px;overflow: scroll">
			...
			<%
					...
					try{
						...
						while (resultSet.next()){
							%>
									<p class="fas fa-user"> <%=resultSet.getString("email") %></p>
									<p ><%=resultSet.getString("comment")%></p>
									<p><a href=Delete>Delete Comment </a></p><hr></hr><br></br>
