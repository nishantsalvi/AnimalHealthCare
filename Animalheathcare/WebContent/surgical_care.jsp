...
<li id="menu-item-21" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-2 current_page_item menu-item-10"><a href="#services">Services</a>
<ul class="sub-menu">
...
<div id="main">	<div id="content">
			...
			<div class="col_lft">
			<h1>Surgical Care</h1>
			<h3>What To Know When Dog Surgery Has Been Recommended </h3>
			<p>At Prestige Animal Hospital, we understand that it can be frightening to receive the news that a dog surgery is being recommended. It is important to understand that it is a recommendation that our veterinarians do not take lightly. If one of our veterinarians is recommending a surgical procedure, rest assured that it is with the best interest of your dog in mind. It is important to us that you understand the reasons as to why a surgical procedure is being recommended and are able to comfortably make the right decisions regarding your dog's health.

Canine surgical procedures fall into two categories where your dog is concerned, elective procedures and those that are urgently necessary.</p>
			<h5>Most common elective dog surgery procedures include:</h5>
			<ul>Spay</ul>
			<ul>Neuter</ul>
			<ul>Dental extractions</ul>
			<ul>Benign growths of the skin</ul>
			
			<h5>Most Dog Surgeries Are Considered To Be Low Risk</h5>
			<p>Surgery always carries with it numerous concerns ranging from potential complications to prognosis for recovery. However, because veterinary medicine has progressed to encompass all modern considerations, the risks are very low to your dog having any major complications from most surgeries.</p>
			<div class="clear"></div>
