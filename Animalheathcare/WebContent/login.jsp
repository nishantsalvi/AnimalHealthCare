...
<ul class="sub-menu">
	<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-79"><a href="register.jsp">Register</a></li>
</ul>
</li>
...
<div id="main">	<div id="content">
			...
			<div class="col_lft">
			<label>Email :</label><span class="wpcf7-form-control-wrap owners_name"><br></br>
			...
			<a href="register.jsp" class="aa">Need a account </a>
